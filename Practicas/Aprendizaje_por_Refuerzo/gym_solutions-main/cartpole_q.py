...
def run(is_training=True, render=False):
    ...
    if is_training:
        ...
        if not os.path.isfile('cartpole.pkl'):
            raise FileNotFoundError("The file 'cartpole.pkl' was not found. Please train the model first.")
...
if __name__ == '__main__':
    ...
    # Luego puedes ejecutar el modelo entrenado
